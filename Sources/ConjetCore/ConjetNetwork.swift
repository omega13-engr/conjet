...
public enum ConjetPortForwardState: String, Codable, Equatable, Sendable {
    case pending
    case reserving
    case reservedWaitingForTarget = "reserved_waiting_for_target"
    case listening
    ...
    case failedAddressInUse = "failed_address_in_use"
    case failedAddressUnavailable = "failed_address_unavailable"
    case failedInvalidAddress = "failed_invalid_address"
    case failedNoRoutableTarget = "failed_no_routable_target"
